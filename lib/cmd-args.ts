...
import schema from '../react-openapi-hooks-gen-schema.json';
import { Options } from './options.js';
import fs from 'fs';
import { kebabCase } from 'lodash';

const Mnemonics: { [key: string]: string } = { input: 'i', output: 'o' };
const DefaultConfig = 'react-openapi-hooks-gen.json';
...
React and Redux projects. Requires a configuration file, which defaults to
...
For help, run react-openapi-hooks-gen --help`);
      }
    } else {
